...
@Component({
  selector: 'app-encuenta',
  templateUrl: './encuenta.component.html',
  styleUrls: ['./encuenta.component.scss']
})
export class EncuentaComponent implements OnInit {
